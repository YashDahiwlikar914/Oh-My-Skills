---
name: ui-ux-pro-max
description: "Use when designing, building, reviewing, or fixing web, mobile, or desktop interfaces, including UI structure, pages, components, design systems, accessibility, interaction, responsive layout, typography, color, charts, icons, animation, and stack-specific UI implementation."
---
