---
name: copywriting
description: Use when the user wants to write, rewrite, or improve marketing copy for a homepage, landing page, pricing page, feature page, about page, product page, headline, CTA, value proposition, tagline, subheadline, or other website text intended to persuade or convert. Use the dedicated email, popup, or offer skill for those requests.
metadata:
  version: 2.0.2
---
