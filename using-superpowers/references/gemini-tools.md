...
Skills dispatch with `Subagent (general-purpose):` and either reference a prompt-template file (e.g., `superpowers:subagent-development`'s `./implementer-prompt.md`) or supply an inline prompt. On Gemini CLI:
