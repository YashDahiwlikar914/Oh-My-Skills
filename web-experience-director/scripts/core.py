...
# -*- coding: utf-8 -*-
"""
Web Experience Director Core - BM25 search engine for UI/UX style guides
"""
...
CSV_CONFIG = {
    ...
    "website-types": {
        "file": "website-types.csv",
        "search_cols": ["ID", "Name", "Family", "Intent", "Keywords", "Primary Pages", "Primary Structures"],
        "output_cols": ["ID", "Name", "Family", "Era", "Intent", "Keywords", "Primary Pages", "Primary Structures", "Responsive Notes", "Accessibility Notes", "Anti-Patterns", "Sources", "Status", "Verified At"]
    },
    "design-languages": {
        "file": "design-languages.csv",
        "search_cols": ["ID", "Name", "Family", "Era", "Intent", "Keywords", "Typography", "Color And Surface", "Best Fit"],
        "output_cols": ["ID", "Name", "Family", "Era", "Intent", "Keywords", "Typography", "Color And Surface", "Motion And Depth", "Best Fit", "Accessibility Notes", "Anti-Patterns", "Sources", "Status", "Verified At"]
    },
    "layout-structures": {
        "file": "layout-structures.csv",
        "search_cols": ["ID", "Name", "Family", "Intent", "Keywords", "Primary Content Fit", "Implementation Notes"],
        "output_cols": ["ID", "Name", "Family", "Intent", "Keywords", "Primary Content Fit", "Responsive Notes", "Accessibility Notes", "Implementation Notes", "Anti-Patterns", "Sources", "Status", "Verified At"]
    }
}

TAXONOMY_DOMAINS = frozenset({
    "website-types", "design-languages", "layout-structures",
})
...
def _domain_keywords():
    ...
    _DOMAIN_KEYWORDS = {
        ...
        "website-types": ["website", "saas", "government", "marketplace", "dashboard", "directory", "booking", "portfolio", "ecommerce", "3d", "product viewer"],
        "design-languages": ["design", "style", "bauhaus", "swiss", "brutalism", "glassmorphism", "3d", "editorial", "kinetic", "y2k"],
        "layout-structures": ["layout", "grid", "single column", "masonry", "bento", "editorial", "carousel", "3d", "spatial", "dashboard"],
    }
    ...
    if exact_style is not None:
        ...
        results, bm25, diagnostic = _search_csv_detailed(
            ...
            row_filter=(
                ...
                if search_domain == "style" or search_domain in TAXONOMY_DOMAINS else None
            ),
            cache_variant="active-only" if search_domain == "style" or search_domain in TAXONOMY_DOMAINS else "",
        )
