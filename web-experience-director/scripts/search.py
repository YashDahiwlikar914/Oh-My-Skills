...
# -*- coding: utf-8 -*-
"""
Web Experience Director Search - BM25 search engine for UI/UX style guides
...
Taxonomies: website-types, design-languages, layout-structures
...
from experience_rules import compose_experience, format_experience
...
def format_output(result, full=False):
    ...
    output = []
    if result.get("stack"):
        output.append("## Web Experience Stack Guidelines")
        output.append(f"**Stack:** {result['stack']} | **Query:** {result['query']}")
    else:
        output.append("## Web Experience Search Results")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Web Experience Director Search")
    ...
    parser.add_argument("--experience", action="store_true", help="Compose a verified-ingredient experience recommendation")
    parser.add_argument("--website-type", type=str, default=None, help="Explicit website type ingredient")
    parser.add_argument("--design-language", type=str, default=None, help="Explicit design language ingredient")
    parser.add_argument("--layout-structure", type=str, default=None, help="Explicit layout structure ingredient")
    ...
    # Experience composition takes priority over the broader design-system output.
    if args.experience:
        ...
        if args.json:
            ...
            print(format_experience(result))
