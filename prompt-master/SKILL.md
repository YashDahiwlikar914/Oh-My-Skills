...
name: prompt-master
version: 1.8.0
description: Use when the user explicitly asks to write, fix, improve, or adapt a prompt for a specific AI tool such as Claude Code, Codex, Cursor, ChatGPT, Midjourney, or another LLM, coding agent, image tool, or video tool. Do not use for general conversation, ordinary coding tasks, document writing, or other non-prompt-engineering work.
