---
name: resume-builder
description: Use when a user asks to create, build, structure, rewrite, tailor, or manage a resume or CV, including Reactive Resume or rxresu.me JSON, resume sections, experience bullets, skills, application tracking, application documents, or resume tailoring for a job, even for one section or bullet. Use PDF or DOCX for artifact-only extraction, merging, conversion, or formatting.
---
