...
description: Use when a user asks to plan, outline, write, revise, format for academic structure, cite, or review an academic research paper, scholarly article, conference paper, survey, thesis chapter, or technical manuscript, including IEEE or ACM style, abstracts, related work, methodology, results, references, figures, tables, or a single section or citation. Do not use for extraction or format-only conversion of an existing paper.
---
